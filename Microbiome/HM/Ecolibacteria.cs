...
namespace Azercadmium.NPCs.Microbiome.HM
{
	public class Ecolibacteria : ModNPC
	{
		...
		{
			if (Main.hardMode)
				return spawnInfo.player.GetModPlayer<AzercadmiumPlayer>().ZoneMicrobiome && !spawnInfo.player.ZoneSkyHeight ? 0.24f : 0f;
			return 0f;
		}
		public override void NPCLoot()
        {
			...
			//	Item.NewItem(npc.getRect(), mod.ItemType("Contagionexite"));
		}
	}
}