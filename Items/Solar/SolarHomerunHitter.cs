...
namespace Azercadmium.Items.Solar
{
	public class SolarHomerunHitter : ModItem
	{
		public override void SetStaticDefaults() {
			Tooltip.SetDefault("Right click to shoot a big solar fragment that explodes into smaller explosive fragments with a 5 second cooldown");
		}
		...
		public override bool UseItem(Player player) {
			if (player.altFunctionUse == 2 && !player.HasBuff(mod.BuffType("BatCooldown"))) {
				player.AddBuff(mod.BuffType("BatCooldown"), 300);
