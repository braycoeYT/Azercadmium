...
namespace Azercadmium.Items.Forest
{
	public class TrueTreeTruncheon : ModItem
	{
		...
		public override void AddRecipes() 
		{
			...
			int treeTruncheon = ModContent.ItemType<TreeTruncheon>();
			int elementalGoop = ModContent.ItemType<Items.Elemental.ElementalGoop>();
			recipe.AddIngredient(treeTruncheon);
			...
			recipe.AddIngredient(elementalGoop, 40);
