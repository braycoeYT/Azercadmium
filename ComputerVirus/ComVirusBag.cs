...
namespace Azercadmium.Items.ComputerVirus
{
	public class ComVirusBag : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Error Loading C:/Tmodloader/Mods/Azercadmium/Items/ComputerVirus/ComVirusBag: Item not found");
