...
{
	internal class FlareSerpentHead : FlareSerpent
	{
		public override string Texture { get { return "Azercadmium/NPCs/Ember/FlareSerpentHead"; } }
	...
	public abstract class FlareSerpent : FlareSerpentWorm
	{
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Flare Serpent");
		}
		public override void SetDefaults() {
		...
		public override void Init() {
			minLength = 14;
			maxLength = 21;
			tailType = NPCType<FlareSerpentTail>();
			bodyType = NPCType<FlareSerpentBody>();
			headType = NPCType<FlareSerpentHead>();
			speed = 10f;
			turnSpeed = 0.07f;
		}
	}
	public abstract class FlareSerpentWorm : ModNPC
	{
		/* ai[0] = follower
		 * ai[1] = following
