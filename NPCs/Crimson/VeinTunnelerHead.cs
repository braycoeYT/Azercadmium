...
{
	internal class VeinTunnelerHead : VeinTunneler
	{
		public override string Texture { get { return "Azercadmium/NPCs/Crimson/VeinTunnelerHead"; } }
	...
	public abstract class VeinTunneler: VeinTunnelerWorm
	{
		...
		public override void Init() {
			minLength = 6;
			maxLength = 12;
			tailType = NPCType<VeinTunnelerTail>();
			bodyType = NPCType<VeinTunnelerBody>();
			headType = NPCType<VeinTunnelerHead>();
			speed = 5.5f;
			turnSpeed = 0.045f;
		}
	}
	public abstract class VeinTunnelerWorm : ModNPC
	{
		/* ai[0] = follower
		 * ai[1] = following
