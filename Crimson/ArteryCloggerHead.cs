...
{
	internal class ArteryCloggerHead : ArteryClogger
	{
		public override string Texture { get { return "Azercadmium/NPCs/Crimson/ArteryCloggerHead"; } }
	...
	public abstract class ArteryClogger : ArteryCloggerWorm
	{
		...
		public override void Init() {
			minLength = 21;
			maxLength = 26;
			tailType = NPCType<ArteryCloggerTail>();
			bodyType = NPCType<ArteryCloggerBody>();
			headType = NPCType<ArteryCloggerHead>();
			speed = 9f;
			turnSpeed = 0.075f;
		}
	}
	public abstract class ArteryCloggerWorm : ModNPC
	{
		/* ai[0] = follower
		 * ai[1] = following
		...
		public override void NPCLoot() {
			...
			Item.NewItem(npc.getRect(), mod.ItemType("BloodySpiderLeg"), Main.rand.Next(3, 9));
		}
	}
}
