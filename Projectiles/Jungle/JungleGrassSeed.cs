...
namespace Azercadmium.Projectiles.Jungle
{
	public class JungleGrassSeed : ModProjectile
	{
		...
		public override void OnHitNPC(NPC target, int damage, float knockback, bool crit) {
			if (Main.rand.NextFloat() < .5f) target.AddBuff(BuffID.Poisoned, Main.rand.Next(10, 21) * 60, false);
		}
		...
		public override void Kill(int timeLeft) {
			...
			if (Main.rand.NextFloat() < .2f) Item.NewItem(projectile.getRect(), ItemID.JungleGrassSeeds);
		}
	}   
}