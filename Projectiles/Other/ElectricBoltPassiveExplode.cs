...
namespace Azercadmium.Projectiles.Other
{
	public class ElectricBoltPassiveExplode : ModProjectile
	{
		...
		public override void Kill(int timeLeft) {
			...
			Projectile.NewProjectile(projectile.Center, new Vector2(0, 0), mod.ProjectileType("ElectricBoltPassiveExplodeExp"), (int)(projectile.damage * 0.8f), 0, Main.myPlayer);
