...
namespace Azercadmium.Projectiles.Cave
{
	...
	{
		private const string ChainTexturePath = "Azercadmium/Projectiles/Cave/BoulderonaChainChain";
		...
		public override void AI() {
			...
			if (projectile.ai[0] == 0f) {
				...
				float maxStretchLength = 192f; // This is the furthest the flail can stretch before being forced to retract. Make sure that this is a bit less than maxChainLength so you don't accidentally reach maxStretchLength on the initial throw.
		...
		public override bool OnTileCollide(Vector2 oldVelocity) {
			if (!bool1) {
				Projectile.NewProjectile(projectile.Center - new Vector2(0, 20), new Vector2(0, 0), ProjectileID.DD2ExplosiveTrapT2Explosion, projectile.damage, 12f, Main.myPlayer);
				bool1 = true;
			}
